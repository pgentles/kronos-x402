...
export function listAutomationCategories(): { name: string; count: number }[] {
...
export function searchAutomations(query: string, category?: string): AgentAutomation[] {
...
export function getAutomation(slug: string): AgentAutomation | undefined {
  return AUTOMATIONS.find(a => a.slug === slug);
}

export function getAllAutomations(): AgentAutomation[] {
  return AUTOMATIONS;
}
